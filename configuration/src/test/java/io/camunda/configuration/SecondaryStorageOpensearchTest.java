...
public class SecondaryStorageOpensearchTest {
  ...
  @TestPropertySource(
      properties = {
        ...
        "camunda.data.secondary-storage.opensearch.bulk.delay=" + EXPECTED_BULK_DELAY,
        "camunda.data.secondary-storage.opensearch.bulk.size=" + EXPECTED_BULK_SIZE,
        "camunda.data.secondary-storage.opensearch.bulk.memory-limit=" + EXPECTED_BULK_MEMORY_LIMIT,
      })
